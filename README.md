...
**단계 5까지 완료, 단계 6 진행 중.** 방과 안내인, 선곡과 재생, 두 권의 책자,
맡길게 모드가 모두 동작하고, 곡을 늘리는 절차도 문서와 점검 도구로 갖춰졌습니다.
지금은 공개 전 검증 중입니다 — 키보드·낭독기 경로를 채웠고, 실제 기기 점검이 남았습니다.
...
| 6 | 공개 전 검증 → 초기 공개 | 진행 중 — [배포와 되돌리기](docs/RELEASE.md) |
